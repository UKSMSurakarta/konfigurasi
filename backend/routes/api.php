...
Route::prefix("v1")->group(function () {
    ...
    Route::middleware("auth:sanctum")->group(function () {
        ...
        Route::middleware("role:superadmin")
            ...
            ->group(function () {
                Route::get("/dashboard", [
                    \App\Http\Controllers\API\Superadmin\DashboardController::class,
                    "index",
                ]);
                ...
                Route::get("users/roles", [
                    \App\Http\Controllers\API\Superadmin\UserController::class,
                    "roles",
                ]);
                Route::apiResource(
                    "users",
                ...
                Route::apiResource(
                    "sekolahs",
                    \App\Http\Controllers\API\Superadmin\SekolahController::class,
                );
                Route::post("sekolahs/import", [
                    \App\Http\Controllers\API\Superadmin\SekolahController::class,
                    "import",
                ]);
                ...
                Route::apiResource(
                    "opds",
                    \App\Http\Controllers\API\Superadmin\OpdController::class,
                );

                // Assessment Period Management
                Route::apiResource(
                    "periods",
                    \App\Http\Controllers\API\Superadmin\AssessmentPeriodController::class,
                );
                Route::patch("periods/{id}/toggle-active", [
                    \App\Http\Controllers\API\Superadmin\AssessmentPeriodController::class,
                    "toggleActive",
                ]);
                ...
                Route::get("pengumumans-opd-list", [
                    \App\Http\Controllers\API\Shared\PengumumanController::class,
                    "opdList",
                ]);
            });
        ...
        Route::middleware("role:admin,superadmin")
            ...
            ->group(function () {
                ...
                Route::prefix("levels")->group(function () {
                    Route::get("/", [
                        \App\Http\Controllers\API\Admin\LevelController::class,
                        "index",
                    ]);
                    Route::post("/", [
                        \App\Http\Controllers\API\Admin\LevelController::class,
                    ...
                    Route::get("/{levelId}/pertanyaans", [
                        \App\Http\Controllers\API\Admin\PertanyaanController::class,
                        "index",
                    ]);
                    Route::post("/{levelId}/pertanyaans", [
                        \App\Http\Controllers\API\Admin\PertanyaanController::class,
                        "store",
                    ]);
                });
                ...
                Route::prefix("laporan")->middleware('throttle:30,1')->group(function () {
                    ...
                    Route::get("/rekap-level", [
                        \App\Http\Controllers\API\Admin\ReportController::class,
                        "rekapLevel",
                    ]);
                    Route::get("/detail-sekolah/{sekolahId}", [
                        \App\Http\Controllers\API\Admin\ReportController::class,
                        "detailSekolah",
                    ]);
                    Route::get("/statistik-periode/{periodId}", [
                        \App\Http\Controllers\API\Admin\ReportController::class,
                        "statistikPeriode",
                    ]);
                });

                // School Management for Admin (CRUD untuk sekolah di OPD mereka)
                Route::apiResource(
                    "sekolahs",
                    \App\Http\Controllers\API\Admin\SekolahController::class,
                );

                // Verification
                Route::prefix("verifikasi")->group(function () {
                    Route::get("/", [
                        \App\Http\Controllers\API\Admin\VerificationController::class,
                        "index",
                    ]);
                    Route::get("/sekolah/{sekolahId}", [
                        \App\Http\Controllers\API\Admin\VerificationController::class,
                        "showDetails",
                    ]);
                    Route::post("/{sekolahId}/level/{levelId}", [
                        \App\Http\Controllers\API\Admin\VerificationController::class,
                        "verify",
                    ]);
                });
        ...
        Route::middleware("role:user,admin,superadmin")
            ->prefix("user")
            ->group(function () {
                Route::post("kontens/upload-image", [
                    \App\Http\Controllers\API\Admin\KontenController::class,
                    "uploadImage",
                ]);
                Route::apiResource(
                    "kontens",
                ...
                Route::patch("kontens/{id}/publish", [
                    \App\Http\Controllers\API\Admin\KontenController::class,
                    "togglePublish",
                ]);
            });
        ...
        Route::middleware("role:sekolah")
            ...
            ->group(function () {
                ...
                Route::get("/levels/{id}/pertanyaans", [
                    \App\Http\Controllers\API\Sekolah\AssessmentController::class,
                    "show",
                ]);
                Route::post("/levels/{id}/jawab", [
                    \App\Http\Controllers\API\Sekolah\AssessmentController::class,
                    "store",
                ]);
                Route::post("/levels/{id}/submit-final", [
                    \App\Http\Controllers\API\Sekolah\AssessmentController::class,
                    "submitFinal",
                ]);
                Route::post("/upload-bukti", [
                    \App\Http\Controllers\API\Sekolah\AssessmentController::class,
                    "upload",
                ]);
                Route::get("/profile", [
    ...
    Route::prefix("public")->group(function () {
        Route::get("/berita", [
            \App\Http\Controllers\API\Public\PublicController::class,
            "berita",
        ]);
