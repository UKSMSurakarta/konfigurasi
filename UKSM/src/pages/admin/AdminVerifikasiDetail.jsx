                            ...
                            {isOpen && (
                                <div>
                                    ...
                                    {lvl.questions.length === 0 ? (
                                        ...
                                        const jawabanStr = String(q.jawaban).toLowerCase();
                                        const isMemenuhi = ["memenuhi", "ya", "100%", "selalu"].includes(jawabanStr);
                                        const isBelum = ["belum memenuhi", "tidak", "belum", "tidak pernah"].includes(jawabanStr);
                                        const isBelumDijawab = jawabanStr === "belum dijawab";

                                        const jawabanBg = isMemenuhi ? "#DCFCE7" : isBelum ? "#FEE2E2" : isBelumDijawab ? "#F3F4F6" : "#DBEAFE";
                                        const jawabanColor = isMemenuhi ? "#16A34A" : isBelum ? "#DC2626" : isBelumDijawab ? "#9CA3AF" : "#1D4ED8";
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div style={{ flex: 1, minWidth: 0 }}>
                                                    ...
                                                    <div style={{ display: "flex", alignItems: "center", gap: "8px", flexWrap: "wrap", marginTop: (q.tipe === 'isian' || (q.jawaban && q.jawaban.length > 30)) ? '8px' : '0' }}>
                                                        {!(q.tipe === 'isian' || (q.jawaban && q.jawaban.length > 30)) && (
                                                            <span style={{
                                                                fontSize: "12px", fontWeight: 700,
                                                        ...
                                                        {q.bukti_links?.length > 0 && q.bukti_links.map((link, li) => {
                                                            ...
                                                            let href = isStr ? link : (link.url || link.path);
                                                                    ...
                                                                    <div key={li} style={{ marginTop: "8px", width: "100%", display: "block" }}>
                                                                        <a href={href} target="_blank" rel="noreferrer" style={{ display: "inline-block" }}>
                                                                            <img
                                                                                src={href}
                                                                                alt={label}
                                                                                style={{ maxWidth: "200px", maxHeight: "200px", borderRadius: "8px", border: "1px solid var(--border)", objectFit: "cover" }}
                                                                            />
                                                                        </a>
                                                                    </div>
                                                                );
